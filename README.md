...
**Note:** Locally changed files will be updated to the Docker container automatically as mirroring is enabled. This means you do not need to run `docker-compose` again to update the files inside the container :)
